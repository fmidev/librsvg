...
%prep
%setup -q -n librsvg-%{version} -c -T
bzcat %{S:0} | tar -xf - --strip-components=1
%patch -p 1
autoreconf -i -f
...
%changelog
* Tue Oct 21 2014 Mika Heiskanen <mika.heiskanen@fmi.fi> - 2.40.6-2
- Pulled updates up to version 2.40.6

* Wed Mar  5 2014 Mika Heiskanen <mika.heiskanen@fmi.fi> - 2.40.1-2
- Added textPath support

* Thu Nov 21 2013 Richard Hughes <rhughes@redhat.com> - 2.40.1-1
- Update to 2.40.1

* Tue Oct 15 2013 Richard Hughes <rhughes@redhat.com> - 2.40.0-1
- Update to 2.40.0
...
* Sat Feb 11 2006 Matthias Clasen <mclasen@redhat.com> 2.13.93-1
- Update to 2.13.93
